---
title: "Hands-on Excercise 5: Visual Correlation Analysis"
author: "Jiang Yuxi"
date: "May 13, 2026"
...
If we want to visually de-emphasize strong correlations instead of removing them.
...
If to hide correlations above a certain threshold (like ∣𝑟∣ < 0.5), we can use the corrplot argument cl.lim or, more flexibly, set unwanted correlations to NA before plotting. corrplot automatically skips NA values.

```{r}
# Copy correlation matrix
wine.cor.filtered <- wine.cor

# Replace correlations with NA if |r| < 0.5
wine.cor.filtered[abs(wine.cor.filtered) < 0.5] <- NA

# Plot with ellipses, lower triangle, no diagonal
corrplot(wine.cor.filtered,
         method = "ellipse",
         type = "lower",
         diag = FALSE,
         tl.col = "black")
