---
title: "Hands-on Excercise 8: Visualising and Analysing Time-oriented Data "
author: "Jiang Yuxi"
date: "May 13, 2026"
...
We use pacman::p_load() to install and launch the following R packages: scales, viridis, lubridate, ggthemes, gridExtra, readxl, knitr, data.table and tidyverse.
...
## 4.3 Step 3: Reshape Data for ggplot
...
## 4.4 Step 4: Extracting the target country

Next, the code chunk below is use to extract data for the target country (i.e. Vietnam)

```{r}
Vietnam <- air %>% 
  filter(Country == "Vietnam", year >= 2010)
```

## 4.5 Step 5: Computing year average arrivals by month
...
## 4.6 Step 6: Plotting the cycle plot
...
rice %>% 
  ...
  newggslopegraph(Year, Yield, Country,
                ...
                SubTitle = "1961-1980",
                Caption = "Prepared by: Jiang Yuxi")
```
